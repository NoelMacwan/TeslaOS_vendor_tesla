...
ALARM_PATH := vendor/tesla/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/tesla/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/tesla/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/tesla/prebuilt/common/media/audio/ui
